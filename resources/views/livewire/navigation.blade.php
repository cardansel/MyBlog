            ...
            <div class="hidden sm:block sm:ml-6">
              <div class="flex space-x-4">
               ...
               {{--  <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>--}}
                <a href="{{ route('posts.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('emails.index')? 'active': '' }}">Blog</a> 
  
                @foreach ($categories as $category)
                  <a href="{{ route('posts.category',$category) }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('post.index')? 'active': '' }}">{{ $category->name }}</a>
                @endforeach
               
                <a href="{{ route('emails.index') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium  {{ request()->routeIs('emails.index')? 'active': '' }}">Contacto</a> 
              </div>
            </div>
          </div>
